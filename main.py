...
# lunar_python vendored package — force-register for Android P4A
...
# Embedded lunar_python modules (21 files inlined for APK compatibility)
import types as _types
_LP_DIR = os.path.join(ENG_DIR, "lunar_python")
_lunar_modules = {}

_lunar_modules["EightChar"] = """\
# -*- coding: utf-8 -*-
...
# Execute all modules into sys.modules
for _mn, _src in _lunar_modules.items():
...
# Create lunar_python namespace package
_lp = _types.ModuleType("lunar_python")
